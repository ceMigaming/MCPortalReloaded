...
public class EntityRocket extends Entity implements Serializable {
	...
	public EntityRocket(World worldIn, double x, double y, double z, EnumFacing facing, BlockPos launcherPos) {
		super(worldIn);
